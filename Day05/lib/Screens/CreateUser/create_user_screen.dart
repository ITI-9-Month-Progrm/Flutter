...
class _CreateUserScreenState extends State<CreateUserScreen> {
  ...
  void validateAndPost(){
    if (_postForm.currentState.validate())
    {
      ...
      newUserBloc.add(AddUser(name:_name,job: _job));
     // showDialog(context, newUserBloc.state.data.newUser.name);
      showDialog(context, _name);


  }
  }
  void showDialog(BuildContext context, String newName){
    Dialogs.materialDialog(
      color: Colors.white,
      msg: '${newName} is a new employee',
